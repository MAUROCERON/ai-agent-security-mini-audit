...
`C:\Users\mauro\OneDrive\PROYECTOS\DINERO\objetivo-50-100usd\landing\index.html`

## Publishing

Upload the full `landing` folder to any static host, or copy the HTML/CSS into a Payhip/Ko-fi/Contra page as supporting sales copy.
